...
def default_rag_client(
    ...
    """
    Create a default RAG client with SiliconFlow DeepSeek LLM and optional retriever.
    ...
    client = ExampleRAG(llm_client=llm_client, retriever=retriever, logdir=logdir, model_name=model_name)
